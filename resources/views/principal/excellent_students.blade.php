...
@section('title', 'Siswa Excellent - AI Learning')
@section('page_header', 'Siswa dengan Capaian Excellent')
@section('page_subtitle', 'Daftar siswa yang mencapai atau melampaui target sekolah.')
...
<div class="modern-card" style="margin-bottom:2rem;">
    <div style="display:flex;justify-content:space-between;align-items:center;">
        <p class="text-slate-500">Sekolah: <strong>{{ $school->school_name }}</strong> — Target: ≥ 75</p>
    ...
    <div class="table-wrapper">
        <table>
            ...
            <tbody>
                ...
                @empty
                <tr><td colspan="{{ 2 + $subjects->count() }}" style="text-align:center;padding:2rem;">Belum ada siswa dengan capaian excellent.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
