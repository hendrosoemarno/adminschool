...
<div class="modern-card" style="margin-bottom:2rem;border-left:4px solid var(--danger);">
    <h3 class="text-slate-800 font-bold mb-4">{{ $subject }}</h3>
    ...
    <div style="margin-bottom:1.5rem;padding:1rem;background:#fef2f2;border-radius:12px;">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:0.75rem;">
            <h4 class="font-bold text-rose-700">{{ $topic }}</h4>
        ...
        <div class="table-wrapper"><table style="font-size:0.85rem;">
            ...
            <tr><td class="font-bold">{{ $st['name'] }}</td><td style="text-align:center;font-weight:800;color:#dc2626;">{{ number_format($st['score'],1) }}</td></tr>
            @endforeach
            </tbody>
        </table></div>
    </div>
