...
<div class="container">
    ...
    <!-- Stats -->
    <div class="stats">
        <a href="{{ url('/demo/principal/student-mastery') }}" class="stat-card" style="border-left:4px solid #4f46e5;">
        ...
        <a href="{{ url('/demo/principal/excellent') }}" class="stat-card" style="border-left:4px solid #059669;">
            <div class="label">Excellent Rate</div>
            <div class="value" style="color:#059669;">64%</div>
            <div class="sub">23 siswa di atas target (75)</div>
        </a>
        <a href="{{ url('/demo/principal/alert') }}" class="stat-card" style="border-left:4px solid #dc2626;">
            <div class="label">Alert Rate</div>
            <div class="value" style="color:#dc2626;">22%</div>
            <div class="sub">8 siswa di bawah KKM (70)</div>
        </a>
        <a href="{{ url('/demo/principal/alert-groups') }}" class="stat-card" style="border-left:4px solid #dc2626;">
