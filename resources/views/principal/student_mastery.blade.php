...
@section('title', 'Detail Mastery Siswa - AI Learning')
@section('page_header', 'Detail Rata-rata Mastery Siswa')
@section('page_subtitle', 'Daftar siswa dengan nilai per mata pelajaran.')
...
<div class="modern-card" style="margin-bottom:2rem;">
    <div style="display:flex;justify-content:space-between;align-items:center;">
        <p class="text-slate-500">Sekolah: <strong>{{ $school->school_name }}</strong> — {{ strtoupper($school->jenjang ?? '-') }}</p>
    ...
    <div class="table-wrapper">
        <table>
            ...
            <tbody>
                ...
                @empty
                <tr><td colspan="{{ 2 + $subjects->count() }}" style="text-align:center;padding:2rem;">Belum ada data siswa.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
