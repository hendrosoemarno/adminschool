...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        /* SOCIAL PROOF */
        .trusted-section { padding:5rem 0; background:#f8fafc; text-align:center; }
        .trusted-section h2 { font-size:2rem; font-weight:800; margin-bottom:1rem; }
        .trusted-section .highlight { color:#059669; }
        .trusted-section p { color:#64748b; max-width:700px; margin:0 auto 3rem; line-height:1.7; font-size:1rem; }
        ...
        .trusted-number { font-size:3.5rem; font-weight:900; color:#059669; }
        .trusted-label { color:#64748b; font-weight:600; }
